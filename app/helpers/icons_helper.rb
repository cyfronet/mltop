module IconsHelper
  ...
  def lock_icon(css_classes = "")
    <<~SVG
      <svg class="#{css_classes}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  def queue_list_icon(css_classes = "")
    <<~SVG
      <svg class="#{css_classes}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
