...
class Challenges::Dashboard::TestSets::EntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get new" do
    ...
    get new_dashboard_test_set_entry_path(test_set)
  ...
  test "should create test set entry" do
    ...
    assert_difference("test_set.entries.count") do
      post dashboard_test_set_entries_path(test_set), params: { test_set_entry: { language: "be", input: dummy_input } }
    end
  ...
  test "should destroy test set entry" do
    ...
    assert_difference("test_set.entries.count", -1) do
      delete dashboard_test_set_entry_path(test_set, test_set_entry)
    end
    assert_redirected_to dashboard_test_set_path(test_set)
  end
end
