...
ActiveRecord::Schema[8.1].define(version: 2025_12_22_124933) do
  ...
  create_table "group_submissions", force: :cascade do |t|
    ...
    t.bigint "model_id"
    t.string "name", null: false
    t.enum "state", default: "processing", null: false, enum_type: "group_submission_state"
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["challenge_id"], name: "index_group_submissions_on_challenge_id"
    t.index ["model_id"], name: "index_group_submissions_on_model_id"
    t.index ["user_id"], name: "index_group_submissions_on_user_id"
  end
  ...
  create_table "hypotheses", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["group_submission_id"], name: "index_hypotheses_on_group_submission_id"
  ...
  add_foreign_key "group_submissions", "challenges"
  add_foreign_key "group_submissions", "models"
  add_foreign_key "group_submissions", "users"
  add_foreign_key "hypotheses", "group_submissions"
